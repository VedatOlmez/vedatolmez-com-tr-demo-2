...
import Logo from "../content/images/web-yazilim-vedat-olmez-logo.png"
      ...
      <div className={`${menuStatus ? "menu-open" : "menu-closed"}`}>
        <header className="header-cont">
          ...
          <nav className="nav-cont">
            <ul>
              <ListLink to="/">Anasayfa</ListLink>
              <ListLink to="/about/">Hakımda</ListLink>
              <ListLink to="/journal/">Blog</ListLink>
              <ListLink to="/contact/">İletişim</ListLink>
            </ul>
          </nav>
        </header>
      </div>
